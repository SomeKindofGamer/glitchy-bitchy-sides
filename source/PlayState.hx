...
class PlayState extends MusicBeatState
{
	...
	public var xx:Int = 1;
	public var yy:Int = 2;
    public var xx2:Int = 3;
    public var yy2:Int = 2;
    public var ofs:Int = 1;
					...
					if (!daNote.mustPress && daNote.wasGoodHit)
					{
						...
						switch (Math.abs(daNote.noteData))
						{
							case 2:
								...
								FlxTween.tween(FlxG.camera, {x: xx, y: yy-ofs});
							case 3:
								dad.playAnim('singRIGHT' + altAnim, true);
								FlxTween.tween(FlxG.camera, {x: xx+ofs, y: yy});
							case 1:
				...
				if (!note.wasGoodHit)
				{
					...
					switch (note.noteData)
					{
						case 2:
							...
							FlxTween.tween(FlxG.camera, {x: xx2, y: yy2-ofs});
						case 3:
							boyfriend.playAnim('singRIGHT', true);
							FlxTween.tween(FlxG.camera, {x: xx2+ofs, y: yy2});
						case 1:
