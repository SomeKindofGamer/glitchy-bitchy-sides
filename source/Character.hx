	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-fusion':
				...
				addOffset('idle', -7, -389);
				addOffset("singUP", -29, -365);
				addOffset("singRIGHT", -38, -407);
				addOffset("singLEFT", 12, -414);
				addOffset("singDOWN", -10, -407);
				addOffset("singUPmiss", -29, -361);
				addOffset("singRIGHTmiss", -38, -383);
				addOffset("singLEFTmiss", 12, -386);
				addOffset("singDOWNmiss", -10, -373);
				addOffset("hey", -7, -389);
