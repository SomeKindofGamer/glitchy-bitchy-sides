...
class OutdatedSubState extends MusicBeatState
{
	...
	{
		super.create();
		var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('sunset', 'shared'));
		bg.scale.x *= 1.55;
		bg.scale.y *= 1.55;
		bg.screenCenter();
		add(bg);
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"Friday Night Funkin': Glitched-Sides"
			+ "\n Version " + MainMenuState.gameVer
			+ "\n Thank you for playing Glitched-Sides!"
			+ "\n This is a remix/reskin mod!"
			+ "\n This mod did take a while to make so please"
			+ "\n Follow us on twitter @FNFGlitchedSide"
